...
cleanup
tox -e ansible-playbook -- -vvv -b -i hosts host-preparation.yml -e "ansible_ssh_user=${USER}"
cleanup
tox -e ansible-playbook -- -vvv -b -i hosts openshift-ansible/playbooks/byo/config.yml -e "ansible_ssh_user=${USER}"
